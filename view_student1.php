...
<body>
	<form name="f11" method="POST" action="view_student1.php">
		<?php 
...
?>
		...
		<label>E-mail</label>
		<input type="text" name="txt_mail" value="<?php echo $row['e_mail'] ?>" readonly="readonly">
	    <label>Phone number</label>
		<input type="text" name="txt_phn" value="<?php echo $row['phon_number'] ?>" readonly="readonly">
